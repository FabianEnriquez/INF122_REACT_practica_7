      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 formato4">
            <div class="card">
              <img
                src="https://intecsa.com.bo/wp
content/uploads/2024/07/LATITUDE-3420-2.jpg"
                class="card-img-top"
                alt="Waterfall"
              />
              <div class="card-body">
          ...
          <div class="col-lg-4 formato4 ">
            <div class="card">
              <img
                src="https://intecsa.com.bo/wp
content/uploads/2024/07/DELL-NB-2n1-Inspiron-14-5410-2.jpg"
                class="card-img-top"
          ...
          <div class="col-lg-4 formato4">
            <div class="card">
              <img
                src="https://intecsa.com.bo/wp
content/uploads/2024/07/NB-HP-PROBOOK-450-G8-2.jpg"
                class="card-img-top"
                alt="Sunset over the Sea"
              />
              <div class="card-body">
